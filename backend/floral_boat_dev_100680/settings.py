"""
Django settings for floral_boat_dev_100680 project.
...
ROOT_URLCONF = 'floral_boat_dev_100680.urls'
...
WSGI_APPLICATION = 'floral_boat_dev_100680.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "floral_boat_dev_100680 API",
    "DESCRIPTION": "API documentation for floral_boat_dev_100680 App",
    "VERSION": "v1",
}
